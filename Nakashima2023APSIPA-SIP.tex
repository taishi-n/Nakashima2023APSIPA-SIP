...
\begin{figure}[t]
  ...
  \label{fig:bss}
\end{figure}
We model the observed signal recorded with a CMA that may be rotated during processing as shown in \cref{fig:bss}.
...
\end{align}
where $\SRC$ is a index set defined as%{\small\todo{（和の範囲を次のようにとる理由…？）}}
\begin{align}
  \SRC &=
  \begin{cases}
