...
\Cref{alg:rtobs} summarises online AuxIVA using SFI for the observed signal.
...
\Cref{fig:plots:bp} shows the beam patterns of demixing matrices calculated with \RTObs{} and \RTCov{} in polar axes.
\begin{figure}[t]
  ...
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/polar_RTcov_rot.pdf}\subcaption{\RTCov{} after rotation.}\label{fig:plot:bp:pol:cov}
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/polar_RTobs_rot.pdf}\subcaption{\RTObs{} after rotation.}\label{fig:plot:bp:pol:obs}
  \end{minipage}
