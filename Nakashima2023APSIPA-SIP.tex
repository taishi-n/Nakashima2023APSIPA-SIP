...
\begin{figure}[t]
  \begin{minipage}[t]{.45\textwidth}
    \centering\includegraphics{figures/plots/online/box_980.pdf}\subcaption{Estimated angle \SI{40}{\degree}, which is equal to the ground truth.}\label{fig:plot:box:980}
  \end{minipage}
  \begin{minipage}[t]{.45\textwidth}
    \centering\includegraphics{figures/plots/online/box_980_err.pdf}\subcaption{Estimated angle \SI{60}{\degree}}\label{fig:plot:box:980:deg60}
  \end{minipage}
