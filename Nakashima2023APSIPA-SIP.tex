...
\begin{figure}[t]
  ...
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/sfiiva-o_rot.pdf}\subcaption{\SFIIVAo{} after rotation.}\label{fig:plot:bp:sfiivao}
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/sfiiva-m_rot.pdf}\subcaption{\SFIIVAm{} after rotation.}\label{fig:plot:bp:sfiivam}
  \end{minipage}
