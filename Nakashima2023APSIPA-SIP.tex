...
As described in \cref{sec:proposed}, naive combination of SFI and online AuxIVA has a problem for practical applications.
...
\end{equation}
Note that $\rotSpat _{\tframe}$ must be known with another sensor, such as an angular acceleration sensor,
%inertial measurement unit sensors 
or estimated from acoustic observation itself
%using some methods, such as maximum likelihood estimation 
\cite{Lian:2021:APSIPA}.
