...
% 216, 252
% 288, 324
\Cref{fig:layout:range} and \cref{fig:layout:exp}, respectively, illustrate the range of the sources' placement and its example.
...
\begin{table}[t]
  ...
  \begin{minipage}[t]{.45\linewidth}
    ...
    \begin{tabular}{lSS}
      ...
      SFIIVA-O &  10.706279 &  21.706356 \\ \rowcolor[gray]{0.8}
...
\begin{figure}[t]
  ...
  \end{minipage}
  \caption{Histogram of SI-SDR improvements (SI-SDRi) before and after CMA rotation.}%
  \label{fig:plot:hist}
\end{figure}
