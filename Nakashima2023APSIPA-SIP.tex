...
Sound field interpolation for circular microphone array (CMA) \cite{Wakabayashi:2023:ASLP} has been proposed to address the rotation of a CMA as one of the time variations of the system.
...
Note that $\rotFra$ and $\rotDeg$ are assumed to be known or estimated in this paper.% because we focus only on the efficacy of sound field interpolation.
