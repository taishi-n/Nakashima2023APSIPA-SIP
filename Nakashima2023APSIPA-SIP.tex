...
\Cref{fig:system} shows the system diagram of our proposed approach.
\begin{figure}[t]
  \centering
  \includegraphics{figures/diagrams/system.pdf}%
  \caption{System diagram of blind source separation combining with sound field interpolation.}%
  \label{fig:system}
\end{figure}
...
\begin{figure}[t]
  ...
  \end{minipage}
  \caption{%
    Room layout. The center of CMA is placed at $(\SI{3.0}{\metre}, \SI{4.0}{\metre})$ in the room. CMA was rotated \SI{40}{\degree} counter-clockwise at \SI{30}{\second}.
