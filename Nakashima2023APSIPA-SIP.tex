  ...
  \begin{pseudo}
    ...
    for $\itr = 1,\, \dots,\, \Itr$ \\+
      ...
      for $\src = 1, \dots, \Src$ \\+
        ...
        \nf{$
          \begin{bmatrix}
            a _{1,1,\ft} & \dots & a _{1,\Src,\ft} \\
            \vdots & \ddots & \vdots \\
            a _{\Src,1,\ft} & \dots & a _{\Src,\Src,\ft}
          \end{bmatrix} \gets \Demix _{\ft} ^{-1}$} \ct{$(\forall \freq)$} \\
        ...
        \nf{$\Est _{\ft} \gets \diag\left(a _{\ell,1,\ft} \; \dots \; a _{\ell,\Src,\ft}\right) \Demix _{\ft} \Obs _{\ft}$} \ct{$(\forall \freq)$}
  \end{pseudo}
\end{algorithm}
...
\Cref{fig:plots:bp:pol} shows the beam patterns of demixing matrices in polar axes.
\Cref{fig:plot:bp:pol:ref} is the result calculated before rotation.
\Cref{fig:plot:bp:pol:cov} and \cref{fig:plot:bp:pol:obs} were respectively calculated with \SFIIVAo{} and \SFIIVAm{} after rotation.
...
% The bright\Cref{fig:plot:bp:pol:obs}, bright areas 
\begin{figure}[t]
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/polar_RTcov_ref.pdf}\subcaption{Before rotation.}\label{fig:plot:bp:pol:ref}
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/polar_RTcov_rot.pdf}\subcaption{\SFIIVAm{} after rotation.}\label{fig:plot:bp:pol:cov}
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/polar_RTobs_rot.pdf}\subcaption{\SFIIVAo{} after rotation.}\label{fig:plot:bp:pol:obs}
  \end{minipage}
...
\Cref{fig:plots:bp} shows the beam patterns of demixing matrices calculated with \RTObs{} and \RTCov{} in linear axes.
\begin{figure}[t]
  \begin{minipage}[t]{\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/linear_RTcov_ref.pdf}\subcaption{Before rotation.}\label{fig:plot:bp:lin:ref}
  \end{minipage}
  \begin{minipage}[t]{\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/linear_RTcov_rot.pdf}\subcaption{\RTCov{} after rotation.}\label{fig:plot:bp:lin:cov}
  \end{minipage}
  \begin{minipage}[t]{\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/linear_RTobs_rot.pdf}\subcaption{\RTObs{} after rotation.}\label{fig:plot:bp:lin:obs}
  \end{minipage}
