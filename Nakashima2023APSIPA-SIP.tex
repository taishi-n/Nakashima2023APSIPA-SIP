...
\Cref{fig:plots:bp} shows the beam patterns of demixing matrices calculated with \RTObs{} and \RTCov{}.
\begin{figure}[t]
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/RTcov_ref.pdf}\subcaption{Before rotation.}\label{fig:plot:bp:ref}
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/RTcov_rot.pdf}\subcaption{\RTCov{} after rotation.}\label{fig:plot:bp:cov}
  \end{minipage}
  \begin{minipage}[t]{.3\linewidth}
    \centering\includegraphics{figures/plots/beam-pattern/RTobs_rot.pdf}\subcaption{\RTObs{} after rotation.}\label{fig:plot:bp:obs}
  \end{minipage}
  \caption{Beam patterns of demixing matrices.}%
  \label{fig:plots:bp}
\end{figure}
